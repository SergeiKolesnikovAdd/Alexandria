      ...
      <ContentWrapper {...props} mt="xxxlg">
        <TextWrapper>
          ...
          <Text style={{ color: colors.white }}>
            Мы помогаем создавать, развивать и продвигать в различные базы
            данных научные журналы и книги издателям абсолютно любого масштаба.
            Самые удобные современные инструменты для ведения публикационной
            деятельности позволяют находить оптимальные решения, исходя из
            потребностей каждого издателя.
          </Text>
        </TextWrapper>
        <SliderWrapper>
          <Slider
