import { Slide, SlideImg, SlideNext, SlidePrev,  SlideWrapper } from "./slider.style";
...
export const Slider = () => {
	...
	const [currentSlide, setCurrentSlide] = useState(slideList[slideList.length-1]);
    ...
    <SlideWrapper>
      {slideList.map(({ img, index, id }) => (
			<Slide key={id} index={index} slideIndex={slideIndex} style={{ zIndex: { index }, top:	 `(10*${id})px`}}>
